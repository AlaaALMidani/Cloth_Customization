...
const Home = () => {
 ...
 <Navbar />
          ...
          {/* Content Section */}
          <motion.section className="relative z-10 w-full min-h-screen p-10 flex items-center justify-center bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('./path-to-your-image.jpg')" }}>
  <motion.div
    ...
    >
      ...
      >
        ...
        <CustomButton
                    ...
                    customStyles="w-fit px-8 py-3 text-lg font-bold bg-[#112732] text-white rounded-lg shadow-lg hover:bg-[#0a1b25] transition-opacity mt-6"
        />
